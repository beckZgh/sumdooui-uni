...
export const page_props = {
    ...
    navbarProps        : { type: Object as PropType<Partial<NavbarProps>>  }, // 导航栏组件 Props
    ...
    loadingProps       : { type: Object as PropType<Partial<LoadingProps>> }, // 加载状态组件 Props
    error              : { type: String   , default: ''                    }, // 页面异常信息
    errorButtonText    : { type: String   , default: '刷新一下'            }, // 页面异常按钮文本
    emptyProps         : { type: Object as PropType<Partial<EmptyProps>>   }, // 页面异常组件 Props
